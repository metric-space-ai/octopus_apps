...
import { keywordValidator } from "../utils/validators";
...
export const AddNewKeyword = ({ open, onClose, addKeyword }: ModalProps) => {
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform border border-content-primary bg-content-grey-100 px-10 py-10 rounded-[20px] align-middle shadow-xl transition-all">
                <div className="flex justify-between items-center">
                  <Dialog.Title
                    as="h3"
                    className="text-left text-2xl font-semibold text-content-black"
                  >
                    {"Add keyword"}
                  </Dialog.Title>
                  ...
                  <div className="relative flex items-center ">
                    ...
                    <span
                      className={classNames(
                        "absolute right-5 text-content-grey-400 text-xs",
                        {
                          "text-content-red-400":
                            getValues().keyword?.length > 100,
                        }
                      )}
