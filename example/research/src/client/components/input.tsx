...
export const Input = ({
  ...
  return (
    <div className={classNames(className)}>
      {label && (
        <p className="mb-2 font-normal text-xs text-content-secondary">
          {label}
        </p>
      )}
      <div
        className={`relative px-5 py-2 bg-content-white rounded-[48px] ${inputCoverClassName}`}
      >
        <input
          {...rules}
          onBlur={onBlur}
          className="w-full text-base text-content-black outline-none border-0"
          type={
