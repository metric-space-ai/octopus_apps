    ...
    <Disclosure key={researchItem.id}>
      {({ open }) => (
        <Fragment>
          ...
          >
            <h5 className="w-36 leading-5 text-xs font-semibold truncate ...">
              {researchItem.name}
            </h5>
            <span className="w-36 ml-1 text-xxs leading-4 text-content-grey-900 truncate ...">
              {researchItem.url}
            </span>
          ...
          <Disclosure.Panel className="flex flex-col rounded-3xl bg-content-grey-100 mb-6 gap-4 px-4 py-3">
            <div className="flex justify-between">
              {researchItem.messages.length > 0 ? (
                ...
                <h6 className="leading-5 text-xs font-semibold text-content-accent">
                  Ask question
                </h6>
              )}
              {researchItem.messages.length > 0 ? (
                <IconButton
                  ...
                  onClick={() => setOpenDisclosure((prev) => !prev)}
                >
                  <ChevronUpIcon
                    className={classNames(
                ...
                {researchItem.messages.map((question) => (
                  <div className="flex flex-col gap-4" key={question.id}>
                    <div className="flex items-start gap-2">
                      <div className="mr-1">
                        <img
                          src={"https://placehold.co/50x50/5f5f5f/fff"}
